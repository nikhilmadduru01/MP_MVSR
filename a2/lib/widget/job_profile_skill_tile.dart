...
class JobProfileSkillTile extends StatelessWidget {
  final Skill skillSelected;
  final bool isDomainSkill;

  const JobProfileSkillTile({
    super.key,
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () {
              if (isDomianSkill) {
                jobData.removeDomainSkill(skillSelected);
              } else {
                jobData.removeOtherSkill(skillSelected);
              }
